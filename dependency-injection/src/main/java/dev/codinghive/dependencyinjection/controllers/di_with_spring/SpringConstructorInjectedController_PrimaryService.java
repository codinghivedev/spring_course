...
@Controller
public class SpringConstructorInjectedController_PrimaryService {

    private final GreetingService greetingService;

    @Autowired //@Autowired is Optional in case of Constructor DI
    public SpringConstructorInjectedController_PrimaryService(GreetingService greetingService) {
